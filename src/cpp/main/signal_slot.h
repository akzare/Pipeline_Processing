 ...
 * @file   signal_slot.h
 *
 * This file is from: https://schneegans.github.io/tutorials/2015/09/20/signal-slot.html
 *
 * @brief   signal_slot.h includes the observer design pattern for the all processing classes
 */
